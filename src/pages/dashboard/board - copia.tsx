...
// Importación de fuentes de datos (JSONs)[cite: 3, 4]
...
export const BoardView: React.FC = () => {
  ...
  // Años disponibles basados en la estructura de capítulos[cite: 4]
  ...
  // 2. Datos para gráfico de barras (Capítulos por año)[cite: 4]
